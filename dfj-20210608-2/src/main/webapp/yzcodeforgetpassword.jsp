				...
				<div class="col-md-6 offset-md-3">
					...
					<div class="login-wrapper">
						...
						<div class="login-block login-block-signin">
							...
							<div class="row">
								<form action="<%=path%>/emailyzcode.do" method="post">
									

									<div class="col-12">
										<div class="form-group">
											<input name="yzcode" type="text" value="${user.yzcode }"
												class="form-control">
												<input name="yzm" type="hidden" value="${user.yzm }"
												class="form-control">
												<a ><input type="submit" 
													class="btn btn-main btn-sm pull-right sendVerifyCode"
													 value="确认验证码"></a>
										</div>
									</div>
									<br>
