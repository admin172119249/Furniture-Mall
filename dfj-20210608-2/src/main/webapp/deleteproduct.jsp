                            ...
                            <div class="clearfix">
                                ...
                                <div class="clearfix">
                                    ...
                                    <div class="info-box">
                                        ...
                                        <span>
                                        	<form action="goodsDelete.do">
                                        	
                                        	<input name="ShopId" value="${shop.shopId}" readonly="readonly" type="hidden">
                    ...
                    <div class="tab-pane fade" id="tab-shipping">
                        ...
                        <div class="col-md-8 offset-md-2">
                            ...
                            <p>
                                ...
                                there's no extra fee for coverage. Itâs automatic and covers your purchase price plus
                            ...
                            <p>
                                Whatever youâre looking for, millions of items on our store are returnable. Before you
                                buy an item, check the sellerâs return policy, then follow these easy steps to
