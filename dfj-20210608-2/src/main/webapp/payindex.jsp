				...
				<dl class="content">
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							...
							<a  class="new-btn-login" style="text-align: center;" href="https://excashier-sandbox.dl.alipaydev.com/standard/auth.htm?payOrderId=90723fd6ebdc43099d1c431d68a7a664.00" target='_BLANK'>付 款</a>
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDtotal_amount").value = "4010";
	}
	GetDateNow();
</script>
</html>