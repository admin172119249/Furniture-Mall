...
<body>
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<a class="title h5">Add a product</a>
			...
			<div class="container">
					...
					<div class="col-lg-4 product-flex-info">
						<div class="clearfix">
								...
								<div class="clearfix">
									...
									<div class="info-box">
										<input name="shopPic"
											...
											readonly="readonly" type="hidden"><span class="col-6">
											<input type="submit" class="btn btn-danger"
											value="Confirm the listing">
										</span>
							...
							<form enctype="multipart/form-data" method="post"
								action="/dfj-20210608-2/upload.do">
				...
				<div class="col-lg-8 product-flex-gallery">
					...
					<div
						...
						<img src="../dfj-20210608-2/assets/images/${filename}">
					</div>
				</div>
