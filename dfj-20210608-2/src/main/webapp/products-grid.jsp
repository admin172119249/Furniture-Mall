...
<body>
	...
	<div class="wrapper">
		...
		<section class="products pt-0"> <!--Header--> <header>
		<div class="container">
			<ol class="breadcrumb">
			...
			class="owl-icons-wrapper d-none"> <header class="d-none">
		<h2>Product icons</h2>
		</header>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-12">
					...
					<!--Search-->
					<form action="queryGoods.do">
						<div class="search-wrapper">

							<input name="condition" value="${sc.condition }"
								class="form-control" placeholder="Search..."> <br>
							<input class="btn btn-outline-dark btn-sm" type="submit"
								value="Search now">
							<c:if test="${loginByr.account eq 'root'}">
								<a href="addproduct.jsp" class="btn btn-outline-dark btn-sm">Add
									a product</a>
							</c:if>
					...
					<div class="row">
						<c:forEach items="${listShop }" var="shop">
							...
							<div class="col-6 col-lg-4">
								...
								<c:if test="${loginByr.account eq 'root'}">
								<div class="info">
									 <a href="goodsDetail2.do?shopId=${shop.shopId}&pageNow=${sc.pageNow}"
										data-title="Delete" > <i
											class="layui-icon layui-icon-delete"></i>
									</a>
									 <a href="goodsDetail1.do?shopId=${shop.shopId}&pageNow=${sc.pageNow}"
										 data-title="Edit"> <i
								...
								<div class="btn btn-add">
									<a
										href="<%=path %>/cartAdd.do?shopId=${shop.shopId}&pageNow=${sc.pageNow}"><i
										class="icon icon-cart"></i></a>
								</div>
								<div class="figure-grid">
									<div class="image">
										<a
											href="<%=path %>/goodsDetail.do?shopId=${shop.shopId}&pageNow=${sc.pageNow}">
											<img src="${shop.shopPic }" alt="" width="750" height="450" />
										</a>
									</div>
									<div class="text">
										<h2 class="title h4">
											<a href="product.jsp">${shop.shopName }</a>
										</h2>
										<br> <sup>${shop.shopPrice }</sup> <span
											class="description clearfix"> Gubergren amet dolor ea
											diam takimata consetetur facilisis blandit et aliquyam lorem
											ea duo labore diam sit et consetetur nulla </span>
									</div>
								</div>
							</div>
							</article>
				...
				<c:if test="${sc.pageNow > 1 }">
					<div class="pagination-wrapper">
						<div class="pagination justify-content-center">
							<a class="page-item"
								href="<%=path %>/queryGoods.do?condition=${sc.condition }&pageNow=1">首页</a>
							<a class="page-item"
								href="<%=path %>/queryGoods.do?condition=${sc.condition }&pageNow=${sc.pageNow - 1}">上
								一页</a>
						</div>
					</div>
				</c:if>
				<c:if test="${sc.pageNow < sc.pageCnt}">
					<div class="pagination-wrapper">
						<div class="pagination justify-content-center">
							<a class="page-item"
								href="<%=path %>/queryGoods.do?condition=${sc.condition }&pageNow=${sc.pageNow + 1}">下
								一页</a> <a class="page-item"
								href="<%=path %>/queryGoods.do?condition=${sc.condition }&pageNow=${sc.pageCnt}">尾页
							</a>
						</div>
					</div>
				</c:if>
			...
			<div class="row scroll">
				...
				<div class="col-6 col-lg-4">
					...
					<div class="figure-grid">
						...
						<div class="image">
							<a href="product.jsp"> <img src="assets/images/product-9.jpg"
								alt="" />
							</a>
						</div>
						<div class="text">
				...
				<div class="col-6 col-lg-4">
					...
					<div class="figure-grid">
						...
						<div class="image">
							<a href="product.jsp"> <img src="assets/images/product-8.jpg"
								alt="" />
							</a>
						</div>
						<div class="text">
							<h2 class="title h4">
								<a href="product.jsp">Ella</a>
							</h2>
	...
	<section class="blog blog-block"> <!--Header--> <header>
	<div class="container">
	...
	<div class="container">
		...
		<div class="row text-center">
			...
			<div class="col-md-4">
				<article data-3d> <a href="products-grid.jsp">
					<div class="image">
			...
			<div class="popup-table">
				...
				<div class="popup-cell">
					<div class="popup-buttons">
						<a href="product.jsp"><span class="icon icon-eye"></span> <span
