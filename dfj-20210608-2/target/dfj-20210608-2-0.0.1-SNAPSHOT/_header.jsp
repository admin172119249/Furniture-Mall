            ...
            <div class="container">
                ...
                <div class="navigation navigation-top clearfix">
                    <ul>
                        ...
                        <li class="left-side"><a href="index.jsp" class="logo-icon"><img src="assets/images/divano-logo.svg" alt="Alternate Text" width="150" height="34"/></a></li>
                        <li class="left-side"><a href="email-template.jsp">Email template</a></li>
                ...
                <div class="navigation navigation-main">
                    ...
                    <div class="floating-menu">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="index.jsp">Boxmenu  <span class="open-dropdown"><i class="fa fa-angle-down"></i></span></a>
                                        ...
                                        <div class="box-sm">
                                            ...
                                            <div class="box">
                                                ...
                                                <div class="clearfix">
                                                    ...
                                                    <a class="btn btn-clean btn-big" href="products-grid.jsp">Shop now</a>
                                                </div>
                                            </div>
                                        </div>
                ...
                <div class="login-wrapper">
                    ...
                    <form>
                        <div class="form-group">
                            <input type="account" class="form-control" id="exampleInputEmail1" placeholder="Account">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <a href="login.jsp" class="open-popup btn btn-main btn-sm">Don't have an account?</a>
                        </div>
                        ...
                        <div class="clearfix">
                            ...
                            <div class="row">
                                ...
                                <div class="cart-block cart-block-item clearfix">
                                    ...
                                    <div class="title">
                                        <div><a href="product.jsp">Product item</a></div>
                            ...
                            <div class="cart-block-buttons clearfix">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <a href="products-grid.jsp" class="btn btn-outline-info">Continue shopping</a>
                                    </div>
                                    <div class="col-sm-6 text-right">
                                        <a href="checkout-1.jsp" class="btn btn-outline-warning"><span class="icon icon-cart"></span> Checkout</a>
                                    </div>
                                </div>
                            </div>
