                        ...
                        <div class="blog-post">
                            ...
                            <div class="blog-post-content pt-0">
                                ...
                                <div class="blog-post-text">
                                    ...
                                    <p>If your room already has a strong style story, simple additions won’t detract from what you already have in there. If your room is neutral or decorated in simple furnishings, then look for dynamic new pieces that give your space that pulled-together look. </p>
                                    ...
                                    <p>Color is the element that can tie your existing furniture with your newly-purchased pieces. Using color as the unifying feature in your space is a simple way to make your new style look effortless. Here’s how to make the most out of color in your room</p>
                                    <ul>
                                        <li>
                        ...
                        <aside>
                            ...
                            <div class="box box-animated box-categories">
                                ...
                                <ul>
                                    ...
                                    <li class="active"><a href="#">Design & decorate</a></li>
                                ...
                                <ul>
                                    <li>
                                        <a href="article.html">
                                            ...
                                            <span class="text">How to Keep Your Heating and Cooling Vents Clean</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="article.html">
                                    ...
                                    <li>
                                        <a href="article.html">
                                            ...
                                            <span class="text">Steal these 3 Home Design Trends for Wedding Decorating Ideas</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="article.html">
                                            ...
                                            <span class="text">Caring for Windows: 5 Tips for People in Glass Houses</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
